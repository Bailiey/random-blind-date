 ...
 * @param {string} matchType - '1on1' 또는 '2on2' (선택 사항)
 */
function showPage(pageNum, matchType = '') {
    // page1에서 넘어올 때 matchType을 설정하는 로직은 startParticipationFlow로 이동
    if (matchType) {
...
// ✨ 새로 추가된 함수: 참가비 팝업 확인 후 학생증 팝업 표시
...
// ✨ 새로 추가된 함수: 학생증 팝업 확인 후 개인정보 동의 페이지로 이동
...
function submitForm(type, event) {
    ...
    dataStorage[type].push(participantData);
